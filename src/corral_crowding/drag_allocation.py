...
class DragOptimizer(GateFidelityOptimizer):
    """Class to generate the optimal frequency allocation given
    system parameters and the ability to pulse shape with DRAG to eliminate
    a single spectator interaction.
    """  # noqa: D205
